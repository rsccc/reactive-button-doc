...
const Example3 = (props) => {
    ...
    const [button2, setButton2] = useState({
        ...
        color: 'blue',
        idleText: 'Blue',
        loadingText: <span className="z-center"><BiLoader className="icon-spin mr-1"/> Loading</span>,
    ...
    const [button3, setButton3] = useState({
        ...
        color: 'yellow',
        idleText: 'Yellow',
        loadingText: <span className="z-center"><ImSpinner9 className="icon-spin mr-1"/> Loading</span>,
        successText: <span> <span><FontAwesomeIcon icon={faCheck}/></span> Success</span>,
        errorText: <span> <span><FontAwesomeIcon icon={faTimes}/></span> Error</span>,
        buttonState: 'loading',
        endState: 'success',
    ...
    const [button4, setButton4] = useState({
        ...
        color: 'dark',
        idleText: 'Dark',
        loadingText: <span className="z-center"><SiSpinrilla className="icon-spin mr-1"/> Loading</span>,
        successText: <span> <span><FontAwesomeIcon icon={faCheck}/></span> Success</span>,
        errorText: <span> <span><FontAwesomeIcon icon={faTimes}/></span> Error</span>,
        buttonState: 'loading',
        endState: 'success',
    ...
    const [button5, setButton5] = useState({
        ...
        color: 'light',
        idleText: 'Light',
        loadingText: <span className="z-center"><ImSpinner8 className="icon-spin mr-1"/> Loading</span>,
        successText: <span> <span><FontAwesomeIcon icon={faCheck}/></span> Success</span>,
        errorText: <span> <span><FontAwesomeIcon icon={faTimes}/></span> Error</span>,
        buttonState: 'loading',
        endState: 'success',
