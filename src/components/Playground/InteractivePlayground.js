...
const InteractivePlayground = () => {
    ...
    const [messageDuration, setMessageDuration] = useState(defaultValues.messageDuration);
                        ...
                        <div className="row" style={{fontSize: '13px'}}>
                                ...
                                <div className="pt-lg-4">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-6">
                                            <select className="form-control form-control-sm" id="buttonState" value={buttonState} onChange={buttonStateOnChangeHandler} disabled={disableButtonStateProp}>
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="buttonState" className="col-sm-5 col-form-label text-lg-right">idleText</label>
                                        <div className="col-sm-6">
                                            <input type="text" className="form-control form-control-sm" id="idleText" placeholder="Click Me" value={idleText} onChange={idleTextOnChangeHandler}/>
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="buttonState" className="col-sm-5 col-form-label text-lg-right">outline</label>
                                        <div className="col-sm-6 align-self-end">
                                            <input type="checkbox" id='outline' checked={outline} onChange={outlineOnChangeHandler} className="z-switch" />
                                        </div>
                                    </div>
                                    <div className="form-group row">
                            ...
                            <div className="col col--6 bootstrap">
                                <div className="pt-lg-4">
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="buttonState" className="col-sm-5 col-form-label text-lg-right">loadingText</label>
                                        <div className="col-sm-6">
                                            <input type="text" className="form-control form-control-sm" id="loadingText" placeholder="Loading" value={loadingText} onChange={loadingTextOnChangeHandler}/>
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="buttonState" className="col-sm-5 col-form-label text-lg-right">block</label>
                                        <div className="col-sm-6 align-self-end">
                                            <input type="checkbox" id='block' checked={block} onChange={blockOnChangeHandler} className="z-switch" />
                                        </div>
                                    </div>
                                    <div className="form-group row">
